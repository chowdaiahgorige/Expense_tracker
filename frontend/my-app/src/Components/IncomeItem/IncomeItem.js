...
function IncomeItem({
    ...
    return (
        <IncomeItemStyled indicator={type === 'expense' ? 'red' : 'green'}>
            <div className="icon">
                ...
                <div className="inner-content">
                    ...
                    <div className="btn-con">
                        <Button 
                            ...
                            bPad={'1rem'}
                            bRad={'50%'}
                            bg={type === 'expense' ? 'red' : 'var(--color-green)'}
                            color={'#fff'}
                            iColor={'#fff'}
    ...
    .content{
        ...
        h5{
            ...
            &::before{
                ...
                height: .8rem;
                border-radius: 50%;
                background: ${props => props.indicator}; /* red for expense, green for income */
            }
        }
        ...
        .inner-content{
            ...
            .text{
                ...
                gap: 1.5rem;
                .amount{
                    color: ${props => props.indicator}; /* red for expense, green for income */
                    font-weight: 700;
                    font-size: 1.4rem;
                }
                p:not(.amount){
